   	...
   	<div class="container">
          ...
          <div class="col-md-6">
            <div class="section-subtitle">
              <h3>
                <?php echo get_field(content_title, 18); ?>
              </h3>
            </div>
            <div class="section-desc">
              ...
              <a class="btn btn-default btn-about btn-aboutc icon-arrow-right" href="<?php echo get_post_permalink(18); ?>" role="button">Read More</a>
            </div>
          </div>        
          <div class="col-md-6">
   		...
   		<div class="section-content">
              ...
              <h3>
                ...
                ?>
   						...
   						<a class="btn btn-default btn-about btn-aboutc icon-arrow-right" href="<?php echo get_post_permalink(18); ?>" role="button">About Us</a>
   					</div>
   				</div>
   			</div>
   		</div>
