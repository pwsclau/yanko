			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="practice-info-title">
						<h3>INJURY CLAIMS ARE ACTIONS IN TORT.</h3>
				...
				<div class="col-md-4">
					<div class="practice-info-title right">
						<h4>PRACTISING LAYWERS</h4>
